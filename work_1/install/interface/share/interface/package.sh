...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/mnt/sda2/code/ros2/work_1/install/interface"
...
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/interface/hook/pythonpath.sh"
