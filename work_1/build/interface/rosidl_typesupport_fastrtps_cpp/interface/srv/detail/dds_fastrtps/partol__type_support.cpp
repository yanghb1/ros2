...
#include "interface/srv/detail/partol__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::srv::Partol_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::srv::Partol_Request & ros_message)
{
  // Member: target_x
  cdr >> ros_message.target_x;
...
{
  auto typed_message =
    static_cast<const interface::srv::Partol_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::srv::Partol_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Partol_Request(full_bounded, 0);
}
...
{
  return &interface::srv::typesupport_fastrtps_cpp::_Partol_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, Partol_Request)() {
  return &interface::srv::typesupport_fastrtps_cpp::_Partol_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::srv::Partol_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::srv::Partol_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
...
{
  auto typed_message =
    static_cast<const interface::srv::Partol_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::srv::Partol_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_Partol_Response(full_bounded, 0);
}
...
{
  return &interface::srv::typesupport_fastrtps_cpp::_Partol_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, Partol_Response)() {
  return &interface::srv::typesupport_fastrtps_cpp::_Partol_Response__handle;
}
...
{
  return &interface::srv::typesupport_fastrtps_cpp::_Partol__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, Partol)() {
  return &interface::srv::typesupport_fastrtps_cpp::_Partol__handle;
}
